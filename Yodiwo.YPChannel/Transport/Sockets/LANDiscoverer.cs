...
namespace Yodiwo.YPChannel.Transport.Sockets
{
    public class LANDiscoverer
    {
        ...
        #region Constructor
        //------------------------------------------------------------------------------------------------------------------------
        public LANDiscoverer(IDiscoveryMessageBase DiscoveryMessage, int DiscoveryMessageMaxSize = 1024, int BroadcastPort = DefaultBroadcastPort)
        {
            ...
            //generate id
            while (myID == 0)   //TODO: fix WORKAROUND FOR UNIVERSAL TO HAVE HIGHER IDS AND BECOME SERVER
#if NETFX
