...
namespace PanicXamarinApp.Droid.DependencyServices
{
    public class AndroidPushNotification : IPushNotification
    {
        ...
        {          
            ...
            //?project=panicxamarinapp

            //            Server API Key AIzaSyCpSVNaGXQss47i7wPuHF0JzwiUKfEHxLg
            //Sender ID 578018573442

            try
            {
                var config = new GcmConfiguration("578018573442", "AIzaSyAEUgAtLMk2-4GZETBW0r6eqFYl8K3yFYk",null);
               // var config = new GcmConfiguration("578018573442", "oym54zD6Uh4b4VhIqmSwUT5f", null);
                ...
                MY_REGISTRATION_IDS[0] = "ramwwindia@gmail.com";
