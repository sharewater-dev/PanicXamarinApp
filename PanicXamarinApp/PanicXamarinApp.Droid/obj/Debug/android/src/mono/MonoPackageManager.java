...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "PanicXamarinApp.Droid.dll" comes first in this list. */
		"PanicXamarinApp.Droid.dll",
		"FFImageLoading.dll",
		...
		"Yodiwo.Logic.BlockLibrary.Basic.dll",
		"Yodiwo.Logic.dll",
		"Yodiwo.NodeLibrary.dll",
		"Yodiwo.NodeLibrary.Graphs.dll",
