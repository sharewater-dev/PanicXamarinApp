...
namespace Yodiwo.NodeLibrary.Graphs
{
    public class NodeGraphManager : Yodiwo.NodeLibrary.Graphs.INodeGraphManager
    {
        ...
        #region Functions
        //------------------------------------------------------------------------------------------------------------------------
        void VirtualOutputMsgHandler(Yodiwo.Logic.Blocks.Endpoints.Out.VirtualOutput.VirtualIOMsg ev)
        {
            //TODO:..
            DebugEx.Assert("TODO");
        }
        //------------------------------------------------------------------------------------------------------------------------
        void VirtualOutputBatchMsgHandler(Yodiwo.Logic.Blocks.Endpoints.Out.VirtualOutput.VirtualIOMsg[] ev)
        {
            try
            {
                //compile events
